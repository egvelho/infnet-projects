...
export class Migration20230529162100 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table `messenger` (`id` int unsigned not null auto_increment primary key, `created_at` datetime not null, `sender_id` int unsigned not null, `receiver_id` int unsigned not null) default character set utf8mb4 engine = InnoDB;');
